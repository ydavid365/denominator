...
public final class RequestTemplate implements Serializable {
    ...
    public Request request() {
        return new Request(methodKey, method, new StringBuilder(url).append(queryLine()).toString(),
    ...
    /**
     * Replaces queries with the specified {@code methodKey} with url decoded
     ...
     * @see #queries()
     */
    public RequestTemplate query(String methodKey, String... values) {
        queries.removeAll(checkNotNull(methodKey, "methodKey"));
        if (values != null && values.length > 0 && values[0] != null) {
            for (String value : values)
                this.queries.put(encodeIfNotVariable(methodKey), encodeIfNotVariable(value));
        }
        return this;
    }
     ...
     */
    public RequestTemplate query(String methodKey, Iterable<String> values) {
        if (values != null)
            return query(methodKey, Iterables.toArray(values, String.class));
        return query(methodKey, (String[]) null);
    }
    ...
    /**
     * Replaces headers with the specified {@code methodKey} with the {@link values}
     * supplied.
     * <p/>
     ...
     * @see #headers()
     */
    public RequestTemplate header(String methodKey, String... values) {
        checkNotNull(methodKey, "header methodKey");
        if (values == null || (values.length == 1 && values[0] == null))
            headers.removeAll(methodKey);
        else
            this.headers.replaceValues(methodKey, ImmutableList.copyOf(values));
        return this;
    }
     ...
     */
    public RequestTemplate header(String methodKey, Iterable<String> values) {
        if (values != null)
            return header(methodKey, Iterables.toArray(values, String.class));
        return header(methodKey, (String[]) null);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(methodKey, method, url, queries, headers, body);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return equal(this.methodKey, that.methodKey) && equal(this.method, that.method) && equal(this.url, that.url)
                && equal(this.queries, that.queries) && equal(this.headers, that.headers)
