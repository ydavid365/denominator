...
public class RequestTemplateTest {
    ...
    public void resolveTemplateWithParameterizedPathSkipsEncodingSlash() {
        ...
        RequestTemplate template = new RequestTemplate().methodKey("Route53#listZones()").method(GET)
                .append("{zoneId}");

        assertEquals(template.toString(), "methodKey[Route53#listZones()]\n"//
                + "GET {zoneId} HTTP/1.1\n");
        ...
        assertEquals(template.request().toString(), "methodKey[Route53#listZones()]\n"//
    ...
    public void resolveTemplateWithBaseAndParameterizedQuery() {
        RequestTemplate template = new RequestTemplate().methodKey("EC2#describeRegions()").method(GET)
        ...
        assertEquals(template.toString(), "methodKey[EC2#describeRegions()]\n"//
        ...
        assertEquals(template.request().toString(), "methodKey[EC2#describeRegions()]\n"//
